# --------------------------------------
Redshift Customer Managed CMK Encryption 
(Encryption at Rest)
# --------------------------------------

→ CfnCluster, encrypted: https://docs.aws.amazon.com/cdk/api/v1/docs/@aws-cdk_aws-redshift.CfnCluster.html
  Cluster, encrypted: https://docs.aws.amazon.com/cdk/api/v1/docs/@aws-cdk_aws-redshift.Cluster.html
