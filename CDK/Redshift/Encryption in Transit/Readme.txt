...
→ CfnClusterParameterGroup, encrypted: https://docs.aws.amazon.com/cdk/api/v1/docs/@aws-cdk_aws-redshift.CfnClusterParameterGroup.html
  ClusterParameterGroup, encrypted: https://docs.aws.amazon.com/cdk/api/v1/docs/@aws-cdk_aws-redshift.ClusterParameterGroup.html
...
# cdk synth > cfn-generated-templates/S3/Encryption-at-Rest/s3-SSE-CMK.yaml
