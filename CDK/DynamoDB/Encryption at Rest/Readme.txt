#######################################
DynamoDB SSE KMS-CMK Encryption 
(Encryption at Rest)
#######################################

→ TableEncryption AWS Documentation Reference: 
  https://docs.aws.amazon.com/cdk/api/v1/docs/@aws-cdk_aws-dynamodb.TableEncryption.html
...
# cdk synth > cfn-generated-templates/DynamoDB/Encryption-at-Rest/dynamodb-SSE-CMK.yaml

7. Deploy the Stack using generated AWS CloudFormation template from the previous step:
cdk deploy
