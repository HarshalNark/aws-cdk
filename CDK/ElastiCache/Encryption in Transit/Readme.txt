...
→ CfnReplicationGroup, transitEncryptionEnabled: https://docs.aws.amazon.com/cdk/api/v1/docs/@aws-cdk_aws-elasticache.CfnReplicationGroup.html
→ CfnCacheCluster, transitEncryptionEnabled: https://docs.aws.amazon.com/cdk/api/v1/docs/@aws-cdk_aws-elasticache.CfnCacheCluster.html
