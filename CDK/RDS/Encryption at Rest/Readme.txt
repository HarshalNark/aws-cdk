#######################################
RDS Customer Managed CMK Encryption 
(Encryption at Rest)
#######################################

→ storageEncrypted AWS Documentation Reference: 
  https://docs.aws.amazon.com/cdk/api/v1/docs/@aws-cdk_aws-rds.DatabaseInstance.html
